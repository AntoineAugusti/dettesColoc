 ...
 * @author Etienne
 */
public class Request extends AsyncTask<String, Void, String> implements ThreadAlertDispatcher{
	...
	public Request(URL target, String method, int connectionTimout, int readTimout) {
		super();
