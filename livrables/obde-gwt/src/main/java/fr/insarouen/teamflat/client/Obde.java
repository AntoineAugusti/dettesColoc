 ...
 */
public class Obde implements EntryPoint {
  /**
  ...
  public void onModuleLoad() {
    ...
    RootPanel.get("nameFieldContainer").add(loginField);
    ...
    class MyHandler implements ClickHandler, KeyUpHandler {
      ...
      private void sendNameToServer() {
        errorLabel.setText("");
        Fakeuser u = new Fakeuser(loginField.getText(), passwordField.getText());
        String textToServer = null;
        if (u.credentialsAreValid())
        	textToServer = "Bienvenue " + loginField.getText() + " !";
        else
        	textToServer = u.returnErrorMessage();
        ...
        greetingService.greetServer(textToServer, new AsyncCallback<String>() {
          ...
          public void onSuccess(String result) {
            dialogBox.setText("Ma modale de connexion !");
